...
function QuickFlashGrenade:_play_sound_and_effects()
        ...
        self._detonated = true
                ...
                local range = 1000 -- DISTANCE A LAQUELLE PLAYER FLASHé
                ...
                managers.network:session():send_to_peers( "sync_smoke_grenade", self._unit:position(), managers.player:player_unit():position(), 1, true )
        end     end
end
...
-----------------------------------------------------------------------------------
        ...
        unit:base():launch( { position = managers.player:player_unit():position(), owner = unit, user = managers.player:player_unit(), dir = managers.player:player_unit():movement():m_head_rot():y(), duration = 1 } )
        end
-----------------------------------------------------------------------------------
